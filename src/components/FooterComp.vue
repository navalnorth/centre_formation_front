<template>
  <div class="flex flex-col items-center w-full h-auto my-10">
    ...
    <div @click="scrollToTop" class="absolute right-0 mr-16 h-16 w-16 content-center flex justify-center items-center cursor-pointer bgBlue hover:bg-slate-400 rounded-full mt-8 ">
